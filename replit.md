...
- **Birthday Automation System:** Automated birthday greetings via Twilio SMS/MMS. Dashboard aggregates birthdays from 7 sources: users, quote_members, policy_members, manual_contacts, manual_birthdays, quotes (client), policies (client).
