...
- **SMS Chat Application (`/incoming-sms`):**
    ...
    - **Conversation Management:** Send SMS, mark as read, search conversations, delete conversations (with confirmation), create new conversations via simple phone number input (formatted automatically with E.164 validation).
