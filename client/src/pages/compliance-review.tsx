...
const smsUseCaseLabels: Record<string, string> = {
  "2FA": "2FA",
  ...
  "COURIER_SERVICES": "Courier Services & Deliveries",
  ...
  "REPAIR_DIAGNOSTICS_ALERTS": "Repair and Diagnostics Alerts",
...
export default function ComplianceReview() {
  ...
  const useCaseLabel = application.smsUseCase 
    ? smsUseCaseLabels[application.smsUseCase] || application.smsUseCase 
    : "";
