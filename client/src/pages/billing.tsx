        ...
        <TabsContent value="transactions" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Complete history of all your invoices and payments</CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs defaultValue="invoices" className="w-full">
                <TabsList className="grid w-full grid-cols-2">
                  <TabsTrigger value="invoices" data-testid="tab-invoices-history">Invoices</TabsTrigger>
                  <TabsTrigger value="payments" data-testid="tab-payments-history">Payments</TabsTrigger>
                </TabsList>
