          ...
          <div className="w-full lg:w-[520px] shrink-0">
            <Card className="border-slate-200 dark:border-slate-800 sticky top-6">
              <CardContent className="p-8">
                <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-6">Widget preview</h3>
                  ...
                  <div className="p-8 text-white">
                    {widget.branding?.customLogo && (
                      <img 
                        src={widget.branding.customLogo} 
                        alt="Logo" 
                        className="h-12 w-auto mb-5 rounded"
                      />
                    )}
                    <h4 className="text-3xl font-bold">{widget.welcomeTitle}</h4>
                    <p className="text-lg opacity-90 mt-4">{widget.welcomeMessage}</p>
                  </div>
