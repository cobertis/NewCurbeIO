...
export default function EmailIntegrationPage() {
      ...
      <div className="container max-w-4xl py-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage your email sending domain and sender profiles</p>
          </div>
  ...
  // If domain is being set up but not verified, redirect to flow
  if (hasDomainConfigured && !isDomainVerified) {
    return (
      <div className="container max-w-4xl py-6 space-y-6">
        <div>
          <h1 className="text-2xl font-semibold mb-1">Email</h1>
          <p className="text-muted-foreground">Complete your domain verification to start sending emails</p>
        </div>
  ...
  // No domain configured - show landing page
  return (
