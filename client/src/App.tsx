...
import FacebookDetails from "@/pages/integrations/facebook-details";
  ...
  return (
    <SidebarProvider style={style as React.CSSProperties}>
      ...
      <div className="grid grid-cols-[4rem,1fr] h-screen w-full bg-gradient-to-br from-slate-100 via-gray-100 to-slate-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="row-span-full px-2 flex flex-col items-center py-4 space-y-3 bg-white dark:bg-gray-900">
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/settings/facebook/details/:id">
        <ProtectedRoute>
          <DashboardLayout>
            <FacebookDetails />
          </DashboardLayout>
