  ...
  return (
    <SidebarProvider style={style as React.CSSProperties}>
      ...
      <div className="grid grid-rows-[auto,1fr] grid-cols-[4rem,1fr] h-screen w-full bg-gradient-to-br from-slate-100 via-gray-100 to-slate-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="col-span-2 px-4 pt-4 pb-2 flex justify-center">
          <header className="h-12 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full shadow-sm border border-gray-200/50 dark:border-gray-700/50 flex items-center px-4 w-fit">
