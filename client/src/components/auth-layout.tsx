...
export function AuthLayout({
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[1120px] h-[700px] flex flex-col lg:flex-row gap-0 relative z-10">
        <div 
        ...
        >
          ...
          <div className="flex flex-col h-full px-10 py-8 relative z-10">
            {/* HeaderBlock - fixed 150px */}
            <div className="h-[150px] shrink-0 flex flex-col justify-center">
              <div className="flex items-center gap-2 mb-4">
                <img src={logo} alt="Curbe" className="h-8 w-auto" />
              </div>
              <h1 className="text-[1.875rem] font-semibold text-gray-900 leading-[1.1] tracking-[-0.02em] mb-1">
                {title}
              </h1>
            ...
            {/* FormBlock - flexible, min 320px max 380px */}
            <div className="flex-1 min-h-[320px] max-h-[380px] flex flex-col">
              {ssoEnabled && (
                <>
                  <button
                    type="button"
                    onClick={onGoogleSSO}
                    className="w-full h-[48px] flex items-center justify-center gap-3 bg-white border border-gray-200 rounded-xl text-[14px] font-medium text-gray-700 hover:bg-white hover:border-gray-300 hover:shadow-sm transition-all duration-150 shrink-0"
                    style={{
            ...
            {/* FooterBlock - fixed 110px */}
            <div className="h-[110px] shrink-0 flex flex-col justify-end pb-2">
              {footer}
            </div>
          </div>
        </div>
