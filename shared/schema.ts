...
export const telnyxGlobalPricing = pgTable("telnyx_global_pricing", {
  ...
  callForwardingPerMinuteCost: numeric("call_forwarding_per_minute_cost", { precision: 10, scale: 4 }).notNull().default("0.0047"),
  ...
  callForwardingPerMinute: numeric("call_forwarding_per_minute", { precision: 10, scale: 4 }).notNull().default("0.0100"),
